package com.starter.security.domain.user.service;

import com.starter.security.domain.jwt.service.RedisService;
import com.starter.security.domain.user.entity.SocialProviderType;
import com.starter.security.domain.user.entity.UserEntity;
import com.starter.security.domain.user.entity.UserRoleType;
import com.starter.security.domain.user.model.CustomOAuth2User;
import com.starter.security.domain.user.model.UserRequestDTO;
import com.starter.security.domain.user.model.UserResponseDTO;
import com.starter.security.domain.user.repository.UserRepository;
